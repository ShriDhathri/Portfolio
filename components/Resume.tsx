...
const Resume = () => {
    const handleDownloadResume = () => {
        ...
        link.href = '/resume/Dhathri_P_M.pdf'
        link.download = 'Dhathri_P_M.pdf'
    ...
    return (
        <section
            id="resume"
            className="bg-background text-foreground py-16 px-6 transition-colors duration-300"
        >
                ...
                <div className="mb-12">
                    <div className="flex justify-between items-start mb-4">
                        <div className="inline-block">
                            <h1 className="text-4xl font-bold text-foreground mb-1">Resume</h1>
                    ...
                    <div>
                        ...
                        <div className="border-l-2 border-green-500 pl-6 relative space-y-10">
                            ...
                            <div className="relative">
                                ...
                                <p className="italic text-foreground mt-1">BITS Pilani</p>
                    ...
                    <div>
                        ...
                        <div className="border-l-2 border-green-500 pl-6 relative space-y-10">
                            ...
                            <div className="relative">
                                ...
                                <p className="italic text-foreground mt-1">
                                    Alva&#39;s Institute of Engineering &amp; Technology (VTU),
                                    Karnataka
                                </p>
                                <p className="text-foreground mt-2 text-sm">
                                    Specialized in Data Science Engineering with focus on machine
                                    learning, Python programming, and data analysis. Actively
                                    involved in research projects and practical applications of
                                    data science.
                                </p>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <p className="text-foreground mt-2 text-sm">
                                    ...
                                    stream, building foundation for computer science and
                                    mathematics.
                                </p>
                            </div>
                        </div>
